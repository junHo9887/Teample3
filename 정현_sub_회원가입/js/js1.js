function slideShow(index) {
  const slider = document.getElementsByClassName("backg")[0],
...
/* ex. 이미지가 5개이고 현재 currentIndex가 3일 경우 (3 + 1) % 5는되어 다음 이미지의 index로 설정. 만약 현재 currentIndex가 4일 경우+ 1) % 5는 0이 되어 다시 첫 번째 이미지의 index로 설정. */
